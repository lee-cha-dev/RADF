    ...
    kpi: {
      ...
      options: {
        variant: {
          type: 'enum',
          label: 'Variant',
          options: ['clean', 'accent', 'halo', 'icon', 'compact'],
          default: 'clean',
        },
        subtype: {
          type: 'enum',
          label: 'Subtype',
          options: ['auto', 'standalone', 'embedded'],
          default: 'auto',
          help: 'Auto embeds when the panel has a title or subtitle.',
        },
        showLabel: {
          type: 'enum',
          label: 'Show label',
          ...
          default: 'auto',
          help: 'Auto hides the KPI label when the panel title exists.',
        },
        showCaption: {
          type: 'enum',
          label: 'Show caption',
          options: ['auto', 'true', 'false'],
          default: 'auto',
          help: 'Auto shows caption when provided.',
        },
        format: {
          type: 'enum',
          label: 'Number format',
